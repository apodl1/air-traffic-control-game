...
//class for representing larger squares used for map generation, the ratio of pixels (Coords) to a GridPos is passed as parameter to GameState and can vary if needed
class GridPos(val x: Int, val y: Int):

  override def toString: String = s"${x}, ${y}"

  //helpers for summing GridPos and/or CompassDir
  ...
  //convert GridPos to Coord, return coord in the middle of Grid Pos, needs the ratio of GridPos to Coord as parameter
